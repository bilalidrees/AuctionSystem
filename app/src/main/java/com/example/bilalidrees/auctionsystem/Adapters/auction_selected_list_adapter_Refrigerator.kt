...
class auction_selected_list_adapter_Refrigerator (context: Context, resource: Int, var items: ArrayList<Refrigerator_Data>, private var lambda:(Int, Refrigerator_Data)->Unit) : RecyclerView.Adapter<auction_selected_list_adapter_Refrigerator.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.name!!.setText(user.Companyname)
